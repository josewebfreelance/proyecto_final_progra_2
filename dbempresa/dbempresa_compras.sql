...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `idproveedor` FOREIGN KEY (`idproveedor`) REFERENCES `proveedores` (`idProveedore`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2018-10-29  4:29:30
