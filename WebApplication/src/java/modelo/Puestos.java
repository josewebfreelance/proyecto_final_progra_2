...
public class Puestos extends Empleados {
    ...
    public List<List<String>> listaPuestos() {
        ...
        try {
            ...
            while (consulta.next()) {
                lista.get(0).add(consulta.getString("idPuesto"));
    ...
    public DefaultTableModel llenarPuestos() {
        ...
        try {
            ...
            String query;
            query = "Select puestos.puesto,puestos.idPuesto FROM   puestos order by  puestos.idPuesto asc";
