...
public void setDpi(String prDpi){dpi=prDpi;}
...
public void setIdpuesto(int prIdpuesto){idpuesto=prIdpuesto;}
public int getIdpuesto(){return idpuesto;} 
    
public void setTipopuesto(int prTipopuesto){tipopuesto=prTipopuesto;}
public int getTipopuesto(){return tipopuesto;}
