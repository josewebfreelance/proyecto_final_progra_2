        ...
        try {
            ...
            if (request.getParameter("btnAgregar") != null)
            {
                if (clsPuestos1.ingresar()>0){
                    response.sendRedirect(request.getContextPath() + "/empleados/Empleados.jsp?seleccionado=5");
                }
            else{
                    out.println("<h1>Error...</h1>");
                    out.println("<a href='" + request.getContextPath() + "/empleados/Empleados.jsp?seleccionado=5'></a>");
                }
            }
