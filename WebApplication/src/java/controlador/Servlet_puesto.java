        ...
        try {
            ...
            if (request.getParameter("btnAgregar1") != null) {
                if (clsPuestos1.ingresarpuesto() > 0) {
                    response.sendRedirect(request.getContextPath() + "/puestos/Puestos_.jsp?seleccionado=6");
                } else {
                    out.println("<h1>Error...</h1>");
                    out.println("<a href='" + request.getContextPath() + "/puestos/Puestos_.jsp?seleccionado=6'></a>");
                }
            }
